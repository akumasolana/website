  ...
  return (
    <section id="intro" className="intro">
      ...
      <div className="intro-text">
        ...
        <p>aiming to blend this powerful concept with innovative technology</p>
        <p>to make a significant impact within the Solana Blockchain.<span className="quote">And we emerge from the shadows...</span></p>
      </div>
